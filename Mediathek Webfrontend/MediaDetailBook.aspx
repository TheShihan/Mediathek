<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterMenu.master" AutoEventWireup="true" CodeBehind="MediaDetailBook.aspx.cs" Inherits="Mediathek_Webfrontend.MediaDetailBook" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td style="width: 160px">
                    <b>Erscheinungsjahr:</b></td>
                <td style="width: 10px">
                    &nbsp;</td>
                <td style="width: 200px">
                    <asp:Label ID="LblPublishingYear" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 160px">
