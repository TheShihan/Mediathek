...
{
    public partial class MediaDetailVideo : System.Web.UI.Page
    {
        ...
        {
            MediaVideo media = bl.GetMediaVideoById(mediaId);
            ...
            this.LblDirector.Text = media.Director;
            this.LblRunTime.Text = media.Length != null ? media.Length.ToString() : string.Empty;
            this.LblActors.Text = media.Actors;
