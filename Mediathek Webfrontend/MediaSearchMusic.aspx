<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterMenuMediaSearch.master" AutoEventWireup="true" CodeBehind="MediaSearchMusic.aspx.cs" Inherits="Mediathek_Webfrontend.MediaSearchMusic" %>
...
<asp:Content ID="Content2" runat="server" 
    ...
    DataSourceID="ObjectDataSourceMedia" CssClass="GridView" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Artist" HeaderText="Künstler/Band" 
...
<asp:ObjectDataSource ID="ObjectDataSourceMedia" runat="server" 
    SelectMethod="GetMediaMusicByCatId" TypeName="BusinessLogic.BusinessLogicHandler">
    <SelectParameters>
