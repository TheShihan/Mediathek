...
{
    /// <summary>
    /// General media detail page
    /// </summary>
    public partial class MediaDetailGeneral : System.Web.UI.Page
    {
        ...
        {
            MediaMisc media = bl.GetMediaMiscById(mediaId);
            ...
            this.LblShortDesc.Text = media.ShortDescription;
